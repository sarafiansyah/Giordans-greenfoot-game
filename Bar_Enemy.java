 ...
 */
public class Bar_Enemy extends Actor
{
...
//  The color of the bar AT the breakpoint will be the average color between the safe color and the danger color
     ...
     */
    public Bar_Enemy(String refText, String unitType, int initValue, int maxValue)
    {
...
private void moveEnemy()
    {
        ...
        int hpmovspeed = 5;
        // Enemy1_1
        java.util.List Enemy1_1 = getWorld().getObjects(Enemy1_1.class);
        if (! Enemy1_1.isEmpty()){
            Enemy1_1 actor = (Enemy1_1)Enemy1_1.get(0);
            turnTowards(actor.getX(), actor.getY()-45);
            
            move(hpmovspeed);
            setRotation(0); // to maintain upright actor
        }
        if(isTouching(Enemy1_1.class)){
