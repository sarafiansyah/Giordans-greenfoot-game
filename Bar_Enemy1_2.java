 ...
 */
public class Bar_Enemy1_2 extends Actor
{
...
//  The color of the bar AT the breakpoint will be the average color between the safe color and the danger color
     ...
     */
    public Bar_Enemy1_2(String refText, String unitType, int initValue, int maxValue)
    {
...
private void moveEnemy()
    {
        ...
        int hpmovspeed = 5;
        // Enemy1_1
        java.util.List Enemy1_2 = getWorld().getObjects(Enemy1_2.class);
        if (! Enemy1_2.isEmpty()){
            Enemy1_2 actor = (Enemy1_2)Enemy1_2.get(0);
            turnTowards(actor.getX(), actor.getY()-45);
            
            move(hpmovspeed);
            setRotation(0); // to maintain upright actor
        }
        if(isTouching(Enemy1_2.class)){
