 ...
 */
public class Bar_Enemy3_3 extends Actor
{
...
//  The color of the bar AT the breakpoint will be the average color between the safe color and the danger color
     ...
     */
    public Bar_Enemy3_3(String refText, String unitType, int initValue, int maxValue)
    {
...
private void moveEnemy()
    {
        ...
        int hpmovspeed = 5;
        // Enemy1_1
        java.util.List Enemy3_3 = getWorld().getObjects(Enemy3_3.class);
        if (! Enemy3_3.isEmpty()){
            Enemy3_3 actor = (Enemy3_3)Enemy3_3.get(0);
            turnTowards(actor.getX(), actor.getY()-45);
            
            move(hpmovspeed);
            setRotation(0); // to maintain upright actor
        }
        if(isTouching(Enemy3_3.class)){
