 ...
 */
public class Bar_Enemy3_4 extends Actor
{
...
//  The color of the bar AT the breakpoint will be the average color between the safe color and the danger color
     ...
     */
    public Bar_Enemy3_4(String refText, String unitType, int initValue, int maxValue)
    {
...
private void moveEnemy()
    {
        ...
        int hpmovspeed = 5;
        // Enemy1_1
        java.util.List Enemy3_4 = getWorld().getObjects(Enemy3_4.class);
        if (! Enemy3_4.isEmpty()){
            Enemy3_4 actor = (Enemy3_4)Enemy3_4.get(0);
            turnTowards(actor.getX(), actor.getY()-45);
            
            move(hpmovspeed);
            setRotation(0); // to maintain upright actor
        }
        if(isTouching(Enemy3_4.class)){
