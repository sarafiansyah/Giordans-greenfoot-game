 ...
 */
public class Bar_EnemyBOSS extends Actor
{
...
//  The color of the bar AT the breakpoint will be the average color between the safe color and the danger color
     ...
     */
    public Bar_EnemyBOSS(String refText, String unitType, int initValue, int maxValue)
    {
...
private void moveEnemy()
    {
        ...
        int hpmovspeed = 5;
        // Enemy1_1
        java.util.List Enemy3_5 = getWorld().getObjects(Enemy3_5.class);
        if (! Enemy3_5.isEmpty()){
            Enemy3_5 actor = (Enemy3_5)Enemy3_5.get(0);
