 ...
 */
public class Stage3DialogMale2 extends World
{
    ...
    public GreenfootSound music = new GreenfootSound("Win.mp3");
    
    public Stage3DialogMale2()
    {    
    ...
    private void prepare()
    {
        ...
        btnStage3_END btnStage3 = new btnStage3_END();
