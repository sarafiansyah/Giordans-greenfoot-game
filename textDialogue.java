 ...
 * @version 1.1
 */
public class textDialogue extends Actor
{
     ...
     */
    public textDialogue(int value, int fontSize)
    {
     ...
     */
    public textDialogue(String value, int fontSize)
    {
        this.value = value;
    ...
    {
        setImage(new GreenfootImage(value, fontSize, fillColor, transparent));
    }
}
